...
public class Log {
    ...
    private static final File logfile = OsUtils.getAppDir(Paths.FILE_LOG);
    private static final File logsDir = OsUtils.getAppDir(Paths.DIR_LOGS, true);
    private static final HashMap<Integer, LogMonitor> monitors = new HashMap<Integer, LogMonitor>();
    /**
     * Logging enabled
     */
