...
public class PropertyManager {
    ...
    public PropertyManager(File file, String comment) {
        this.file = file;
        entries = new TreeMap<String, Property>();
        setValues = new TreeMap<String, String>();
        keyRename = new TreeMap<String, String>();
        fileComment = comment;
    }
    ...
    public void apply() {
        ...
        // rename keys
        for (final Map.Entry<String, String> entry : keyRename.entrySet()) {
    ...
    public void cfgNewlineBeforeComments(boolean newlineBeforeComments) {
        cfgNewlineBeforeComments = newlineBeforeComments;
    }
    ...
    public void cfgSeparateSections(boolean separateSections) {
        cfgSeparateSections = separateSections;
    }
    ...
    private static class PropertiesLoader {
        ...
        public static SortedProperties loadProperties(SortedProperties props, InputStream is, String encoding) throws IOException {
            ...
            final byte[] bs = inputString.getBytes(StandardCharsets.ISO_8859_1);
